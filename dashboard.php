            ...
            <section style="padding-left: 20px; padding-right: 20px;">
                <div class="col-sm-3">
                    <div class="card card-green">
                        ...
                        <h3 style="color: #282828; text-align: center;"><?php echo $total_products['products'] ?></h3>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card card-yellow" >
                        <h4>Products Bought </h4>
                        <h3 style="color: #282828; text-align: center;"><?php echo $total_bought['total_bought'] ?></h3>
                    </div>
                </div>
                <div class="col-sm-3 " >
                    <div class="card card-blue" >
                        <h4>Products Sold </h4>
                        <h3 style="color: #282828; text-align: center;"><?php echo $total_sold['total_sold'] ?></h3>
                    </div>
                </div>
                <div class="col-sm-3" >
                    <div class="card card-red" >
                        <h4>Available Stock </h4>
                        <h3 style="color: #282828; text-align: center;"><?php echo $stock_available ?></h3>
                    </div>
                </div>
            </section>
        </div>
